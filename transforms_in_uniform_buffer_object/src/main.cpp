...
GLuint VAO, VBO, shaderProgram, uboModelMatrices;
...
int main() {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 600, "transforms in uniform buffer", nullptr, nullptr);
    if (!window) {
    ...
    const char *vertexShaderSource = R"(
        ...
        layout(std140) uniform ModelMatrices {
            mat4 modelMatrices[100];  // Model matrices for each triangle
        };
    ...
    glDeleteBuffers(1, &uboModelMatrices);
